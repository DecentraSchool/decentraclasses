export const GPTcontent = {
  section: [
    {
      title: "A Guide to create Ebooks using Chat GPT",
      lecturesCount: "1",
      totalDuration: "6 min",
      lecture: [
        {
    ...
    {
      title: "You can use ChatGPT to create an extensive Vareity of Emails",
      lecturesCount: "1",
      totalDuration: "9 min",
      lecture: [
        {
    ...
    {
      title: "Will google replace Chat GPT?",
      lecturesCount: "1",
      totalDuration: "7 min",
      lecture: [
        {
    ...
    {
      title: "Gathering Biographical Information",
      lecturesCount: "1",
      totalDuration: "5 min",
      lecture: [
        {
