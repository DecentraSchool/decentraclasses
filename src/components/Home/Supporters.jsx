    ...
    <div className="pb-32 sm:px-10 px-5 flex flex-col items-center gap-24 justify-center">
      ...
      <dxiv className="flex xl:gap-24 lg:gap-20 gap-16  w-full xl:px-12 flex-wrap justify-center">
        <Card
          ...
          widS={48}
          paraS={
            "Composable and robust media infrastructure to enable cross-chain audio and video communication between users."
          }
        />
        <Card
          imgS={lighthouse}
          ...
          widS={56}
          paraS={
            "Decentralized database powered by zero knowledge proofs, with attributes of a blockchain and the speed & privacy of a database."
          }
        />
        <Card
          imgS={polybase}
          titleS={"Polybase"}
          link={"https://polybase.xyz/"}
          widS={32}
          paraS={
